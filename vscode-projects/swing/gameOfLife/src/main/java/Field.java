...
public class Field extends JPanel implements MouseInputListener  {
    ...
    public void paintComponent(Graphics g) {
        ...
        double cellWidth = getWidth() / (double) gameWidth;
        double cellHeight = getHeight() / (double) gameHeight;
    ...
    private Point gameFieldCoordinates(MouseEvent e) {
        ...
        double cx = getWidth() / (double) gameWidth;
        double cy = getHeight() / (double) gameHeight;
